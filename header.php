               ...
               <div id="masthead" class="header-main hide-for-sticky">
                  ...
                  <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                     ...
                     <div id="logo" class="flex-col logo">
                        ...
                        <a href="<?php echo home_url() ?>" class="d-flex" rel="home">

                           <img width="60"src="<?php echo get_field("op_logo_header","option")['url'] ? get_field("op_logo_header","option")['url'] : P_IMG  . '/wp.png' ?>" class="header_logo header-logo" alt="Logo" style="height:60px;">
                           <img width="60"src="<?php echo get_field("op_logo_header2","option")['url'] ? get_field("op_logo_header2","option")['url'] : P_IMG  . '/osg-logo.jpg' ?>" class="header_logo header-logo" alt="Logo" style="height:60px;margin-left:30px;">
                        </a>
                        

                     </div>
                     <div><h1 class="site-title">PSMCVN - <span class="--text1">Chất lượng</span> - <span class="--text2">Chính hãng OSG</span></h1></div>

                     <!-- Mobile Left Elements -->

                     <div class="flex-col show-for-medium flex-left d-none">
                     ...
                     <div class="flex-col hide-for-medium flex-right">
                        ...
                        <ul class="header-nav header-nav-main nav nav-right  nav-uppercase">
                           ...
                           <li class="html custom html_topbar_right"><a rel="noopener noreferrer" href="tel:<?php echo @str_replace(" ", "",  get_field("op_he_con_phone","option")); ?>" target="_blank" class="hotline-button btn">

                              <!-- <i class="fa fa-phone"></i>  -->
                              <svg style="margin-right:10px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-forward-fill" viewBox="0 0 16 16">
