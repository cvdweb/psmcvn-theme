...
defined( 'PLL_TRS_DIR' ) ||  define('PLL_TRS_DIR', dirname(__FILE__));
defined( 'PLL_TRS_INC' ) ||  define('PLL_TRS_INC', PLL_TRS_DIR . '/include');

if ( !class_exists('Polylang_Translate_Rewrite_Slugs') ):
